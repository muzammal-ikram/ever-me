...
<head>
    ...
    <!-- Title -->
    <title>EverHost {{ $property['property_name'] }}</title>
...
<body>
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div class="fadeIn first">
                <p>Enter the given password to view the property</p>
            </div>

            <!-- Password Form -->
            <form method="POST" action="{{route('restricted_login')}}">
                @csrf
    ...
    <script type="text/javascript">
        ...
        function formatOptions(platform) {
            ...
            var $platform = $(
                '<span ><img sytle="display: inline-block;width:50px;" src="images/' + platform.element.value
                .toLowerCase() + '.jpg" /></span>'
                //' + platform.text + '
            );
            return $platform;
        }
