...
if( $('#map_canvas').length > 0 ){	
	 // When the window has finished loading create our google map below
		...
		function init() {
			...
			'<h5 class="infowindow-header">xyx Pvt Ltd</h5>'+
			'<div class="infowindow-body"><p class="txt-dark mb-15">121 King Street, <br>Melbourne VIC 3000, Australia</p><a href="" target="_blank">www.xyz.com</a></div>'+
			'</div>';
